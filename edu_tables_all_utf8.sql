/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_CUSTOMER
-- 만든 날짜: 2017-08-23 오후 10:05:01
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:06:26
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_CUSTOMER CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_CUSTOMER (
...
ALTER TABLE c##c##student.S_CUSTOMER ADD
(
...
/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_EMP
-- 만든 날짜: 2017-08-23 오후 12:22:27
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:07:05
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_EMP CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_EMP (
  ID               NUMBER(7)             NOT NULL, 
...
ALTER TABLE c##student.S_EMP ADD
(
    CONSTRAINT PK_S_EMP
    PRIMARY KEY ( ID )
        USING INDEX
...
GRANT SELECT ON c##student.S_EMP TO TEST WITH GRANT OPTION;

GRANT INSERT ON c##student.S_EMP TO TEST WITH GRANT OPTION;



/*------------------------------------------------------------------------------
-- 개체 이름: c##student.SALGRADE
-- 만든 날짜: 2017-08-23 오후 10:00:38
-- 마지막으로 수정한 날짜: 2017-08-30 오전 11:34:57
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.SALGRADE CASCADE CONSTRAINTS;

CREATE TABLE c##student.SALGRADE (
...
/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_DEPT
-- 만든 날짜: 2017-08-23 오전 10:36:02
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:06:40
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_DEPT CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_DEPT (
  ID           NUMBER(7)             NOT NULL, 
  NAME         VARCHAR2(25 BYTE)     NOT NULL, 
  REGION_ID    NUMBER(7)                 NULL
)
...
ALTER TABLE c##student.S_DEPT ADD
(
...
/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_ITEM
-- 만든 날짜: 2017-08-23 오후 12:14:12
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:05:44
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_ITEM CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_ITEM (
...
ALTER TABLE c##student.S_ITEM ADD
(
...
/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_ORD
-- 만든 날짜: 2017-08-23 오후 10:02:48
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:06:05
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_ORD CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_ORD (
  ID              NUMBER(7)            NOT NULL, 
...
ALTER TABLE c##student.S_ORD ADD
(
    CONSTRAINT PK_S_ORD
    PRIMARY KEY ( ID )
        USING INDEX
...
/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_PRODUCT
-- 만든 날짜: 2017-08-23 오후 9:59:21
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:07:20
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_PRODUCT CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_PRODUCT (
  ID            NUMBER(7)              NOT NULL, 
  NAME          VARCHAR2(50 BYTE)      NOT NULL, 
...
ALTER TABLE c##student.S_PRODUCT ADD
(
...
/*------------------------------------------------------------------------------
-- 개체 이름: c##student.S_REGION
-- 만든 날짜: 2017-08-23 오전 10:37:32
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:07:32
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE c##student.S_REGION CASCADE CONSTRAINTS;

CREATE TABLE c##student.S_REGION (
  ID      NUMBER(7)             NOT NULL, 
...
ALTER TABLE c##student.S_REGION ADD
(
...
INSERT INTO c##student.S_REGION
  (ID, NAME)
VALUES
  (1, '서울특별시');
...
INSERT INTO c##student.SALGRADE
  (GRADE, LOSAL, HISAL)
VALUES
  ('A', 4000, 5999);
...
INSERT INTO c##student.S_CUSTOMER
